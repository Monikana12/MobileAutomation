...
public class MobileAPI {
    ...
    public static AppiumDriver getDriver(String OS, String deviceName, String version,
        ...
        if (OS.equalsIgnoreCase("android")) {
            ...
            cap.setCapability(MobileCapabilityType.APP_PACKAGE, "com.espn.score_center");
            cap.setCapability(MobileCapabilityType.APP_ACTIVITY, "com.espn.sportscenter.ui.LaunchActivity");
